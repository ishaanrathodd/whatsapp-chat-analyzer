...
if uploaded_file is not None:
    ...
    media_df = preprocesser.preprocess(data)
    non_media_df = preprocesser.preprocess_clean(data)
    ...
    if st.sidebar.button("Show Analysis"):
        num_messages, words, num_videos, num_images, num_stickers, num_audios, links = helper.fetch_stats(selected_user,
                                                                                                          media_df)
        st.title("Statistics")
